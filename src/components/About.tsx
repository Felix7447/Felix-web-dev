...
const About = ({ dictionary }: { dictionary: About }) => {
  ...
  return (
    <section id='about' className='max-w-7xl mx-auto grid grid-cols-12 min-h-screen dark:bg-primary bg-text py-10 px-8 lg:px-28 text-center'>
      ...
      <div data-aos='fade-left' className='col-span-12 w-full flex justify-center items-center my-8 px-4 md:my-0 md:col-span-4 md:order-2'>
      ...
      <aside data-aos='fade-right' className='col-span-12 flex items-center dark:text-text text-secondary md:col-span-8 md:order-1'>
